...
const redisResponseCache = require("../middlewares/redisResponseCache");

const cacheAdminDetailResponse = redisResponseCache("admin:dm-detail:v1", 180);
const cacheAdminPageResponse = redisResponseCache("admin:page:v1", 120);
const cacheAdminSettingsResponse = redisResponseCache("admin:settings:v1", 60);
...
router.get(
  "/admin/revenue/platform-intelligence",
  authadmin,
  cacheAdminPageResponse,
  getPlatformRevenueIntelligence,
);
...
router.get(
  "/admin/companies/:companyId/full",
  authadmin,
  cacheAdminDetailResponse,
  getCompanyFullDetail,
);
router.get(
  "/admin/workers/:workerId/full",
  authadmin,
  cacheAdminDetailResponse,
  getWorkerFullDetail,
);
...
router.get(
  "/admin/design-request/:id",
  authadmin,
  cacheAdminDetailResponse,
  getDesignRequestDetail,
);
router.get("/admin/bid/:id", authadmin, cacheAdminDetailResponse, getBidDetail);
router.get(
  "/admin/job-application/:id",
  authadmin,
  cacheAdminDetailResponse,
  getJobApplicationDetail,
);

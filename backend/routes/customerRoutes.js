...
router.get(
  ...
  auth,
  requireRole("customer"),
  redisResponseCache("customer:ongoing-projects:v1", 90),
  getOngoingProjects,
);
router.get(
  "/interiordesign_form",
...
router.get(
  "/customer/accept-proposal/:type/:id",
  auth,
  requireRole("customer"),
  acceptProposal,
);
router.get(
  "/customer/accept-bid/:bidId/:companyBidId",
  auth,
  requireRole("customer"),
  acceptCompanyBid,
);
...
router.post(
  "/customer/reject-proposal/:type/:projectId",
  auth,
  requireRole("customer"),
  rejectProposal,
);
...
router.get(
  "/architect-hiring/:projectId",
  auth,
  requireRole("customer"),
  getArchitectHiringDetails,
);
router.get(
  "/design-request/:projectId",
  auth,
  requireRole("customer"),
  getDesignRequestDetails,
);

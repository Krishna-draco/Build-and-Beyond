...
const cacheAdminPlatformManagerResponse = redisResponseCache(
  "admin:platform-managers:v1",
  120,
);
...
router.get(
  ...
  authadmin,
  requireSuperadmin,
  cacheAdminPlatformManagerResponse,
  getAllPlatformManagers,
);
router.get(
  "/admin/platform-managers/:id/performance",
  authadmin,
  requireSuperadmin,
  cacheAdminPlatformManagerResponse,
  getPlatformManagerPerformance,
...
router.delete(
  "/admin/platform-managers/:id",
  authadmin,
  requireSuperadmin,
  deletePlatformManager,
);
router.patch(
  "/admin/platform-managers/:id/toggle-status",
  authadmin,
  requireSuperadmin,
  togglePlatformManagerStatus,
);
...
router.post(
  "/platform-manager/change-password",
  authadmin,
  changePlatformManagerPassword,
);
...
router.get(
  "/platform-manager/verification/:taskId",
  authadmin,
  getVerificationTaskDetails,
);
router.post(
  "/platform-manager/verification/:taskId/process",
  authadmin,
  processVerificationTask,
);
...
// Reply to complaints
router.get(
  "/platform-manager/complaint/:complaintId",
  authadmin,
  getComplaintDetailsPM,
);
router.post(
  "/platform-manager/complaint/:complaintId/reply",
  authadmin,
  replyToComplaintPM,
);
...
router.get(
  "/platform-manager/company-payments",
  authadmin,
  getCompanyPaymentQueue,
);
router.post(
  "/platform-manager/company-payments/:projectId/:milestonePercentage/collect",
  authadmin,
  collectCompanyPlatformFee,
);
